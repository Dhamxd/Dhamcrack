...
'Mozilla/5.0 (Linux; U; Android 9; Redmi Note 8 Build/PKQ1.190616.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/86.0.4240.185 Safari/537.36 OPR/52.2.2254.54723',
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r â”€5.py {h}{P}{b}{loop}{P}/{P}{len(id)}{P} {H}OK:{P}{ok}{P} {k}CP:{P}{cp}{x}  {P}{'{:.0%}'.format(loop/float(len(id)))}{P}  "),
	sys.stdout.flush()
